...
bool SplashScene::init()
{
    ...
    auto sprite2 = Sprite::create("rollersplat.png");
    sprite1->setPosition(visibleSize.width/1.3, visibleSize.height/2);
    sprite1->setScale(1.1);
    sprite2->setPosition(visibleSize.width/0.9 , visibleSize.height / 2);
